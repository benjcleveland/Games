...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.image_name'
        db.add_column('gameviewer_game', 'image_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.image_name'
        db.delete_column('gameviewer_game', 'image_name')
